void one_press(){
  ...
  forward_degree(120,1400);wait(500);//出發前進第二關20 
  ...
  forward_degree(130,760);wait(500);//前進
  ...
  forward_degree(210,5000);forward_degree(210,5000);forward_degree(210,5000);forward_degree(210,5000);wait(500);//4200只能爬上去第一階
